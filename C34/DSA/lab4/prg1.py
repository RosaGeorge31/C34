...
class BinarySearchTree:
    ...
    def successor(self,x,key):
        ptr = self.search(x,key)
        if ptr is None:
            return None
        if ptr == self.maximum(x):
            return None
        ...
        while ptr != y.left  and y is not None:
            ptr = y
            y = y.parent
        return y
    ...
    def predecessor(self,x,key):
        ptr = self.search(x,key)
        if ptr is None:
             return None
        if ptr == self.minimum(x):
            return None
        if ptr.left is not None:
             ptr = ptr.left
             return self.maximum(ptr)
        
        y=ptr.parent   
        while ptr != y.right and y is not None:
            ptr = y
            y = y.parent
        return y
